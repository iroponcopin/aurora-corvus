...
COPY = {
    "ja": {
        ...
        "ouka_p": "Cherry の上に立つ、最上位のブランド。Cherry や Alpha と併せて導入でき、バージョンは独立して進みます。",
    ...
    "en": {
        ...
        "ouka_p": "The highest tier, above Cherry. It installs alongside Cherry and Alpha and versions independently.",
    ...
    "es": {
        ...
        "ouka_p": "El nivel más alto, por encima de Cherry. Se instala junto a Cherry y Alpha y avanza con su propia versión.",
    ...
    "fr": {
        ...
        "ouka_p": "Le niveau le plus élevé, au-dessus de Cherry. Il s'installe aux côtés de Cherry et d'Alpha et avance avec sa propre version.",
    ...
    "zh": {
        ...
        "ouka_p": "位于 Cherry 之上,最高级别的品牌。可与 Cherry 和 Alpha 一同安装，版本各自独立演进。",
    ...
    "ko": {
        ...
        "ouka_p": "Cherry 위에 서는 최상위 브랜드입니다. Cherry 및 Alpha와 함께 설치할 수 있으며, 버전은 각자 독립적으로 나아갑니다.",
    ...
    "pt-br": {
        ...
        "ouka_p": "O nível mais alto, acima do Cherry. Instala-se ao lado do Cherry e do Alpha e avança com versão própria.",
    ...
    "it": {
        ...
        "ouka_p": "Il livello più alto, sopra Cherry. Si installa accanto a Cherry e ad Alpha e avanza con una versione propria.",
    ...
    "ar": {
        ...
        "ouka_p": "المستوى الأعلى، فوق Cherry. يُثبَّت إلى جانب Cherry و Alpha ويتقدّم بإصدار مستقل.",
    ...
    "ru": {
        ...
        "ouka_p": "Высший уровень — выше Cherry. Устанавливается рядом с Cherry и Alpha и развивается в собственной версии.",
    ...
    "id": {
        ...
        "ouka_p": "Tingkat tertinggi, di atas Cherry. Terpasang berdampingan dengan Cherry dan Alpha, dan melaju dengan versinya sendiri.",
    ...
    "de": {
        ...
        "ouka_p": "Die höchste Stufe, über Cherry. Wird neben Cherry und Alpha installiert und führt seine eigene Version.",
    ...
    "tr": {
        ...
        "ouka_p": "En üst seviye; Cherry'nin üzerinde. Cherry ve Alpha ile birlikte kurulur ve kendi sürümüyle ilerler.",
