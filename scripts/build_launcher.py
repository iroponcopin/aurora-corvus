...
_DEFAULT_SECTIONS = [
    ...
    },
    {
        ...
        "body_html": (
            ...
            "<li><strong>The cross-platform jar</strong>, <code>glimpse-launcher-1.1.0.jar</code> "
            ...
            "<code>java -jar glimpse-launcher-1.1.0.jar</code> from a terminal or command prompt "
