        ...
        "sections": [
            {
                ...
                "diagram": {
                    "caption": "燃料 → 発電機 → ケーブル → 分電盤 → ケーブル → 機器"
                ...
                "steps": [
                    ...
                    "発電機から<b>分電盤</b>まで<b>ケーブル</b>をつなぎます。"
                    "発電機はどの面からでもつながります。",
                ...
                "notes": [
                    "発電機は<b>電気を作るだけ</b>、分電盤は<b>配るだけ</b>です。どちらか片方では動きません。",
                    "うまくいかないときは、まず<b>ケーブルが光っているか</b>を目で追ってください。"
                    "光が途切れたところが原因の場所です。",
                    "<b>原子力発電所</b>は少し違います。分電盤を直接は動かさず、"
                    "<b>エネルギーセルを作って</b>ケーブルで分電盤へ送ります(⑤を見てください)。",
            ...
            },
            {
                ...
                "steps": [
                    ...
                    "<b>原子力発電所</b>が石炭から作ります(1 個あたり約 {reactor_seconds} 秒、"
                    "{reactor_buffer} 個たまると止まって石炭を無駄にしません)。",
                ...
                "notes": [
                    ...
                    "原子力発電所が 1 個作るのに約 {reactor_seconds} 秒かかるので、"
