...
<b>PIN の桁数がそのまま強さである。</b>4 桁なら 10,000 通りしかなく、
暗号文を落とした人が総当たりすれば反復 {@link #ITERATIONS} 回でも数時間で開く。
所有者は 2026-09-07 に 8 桁へ変えた —— 10<sup>8</sup> 通りで、同じ反復回数なら
総当たりは現実的でなくなる(桁を増やすことが、この錠でいちばん効く手当てである)。
それでもここが守っているのは
